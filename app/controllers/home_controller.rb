...
class HomeController < ApplicationController
  ...
  def index
    ...
    @i_lotados = Rails.cache.fetch('i_lotados', :expires_in => 24.hours) {Funcionario.find(:all,:joins=>:lotacoes_atuais,:conditions=>["cargo_id = ? and disciplina_contratacao_id is null",Cargo.find_by_nome("PROFESSOR")]).uniq}
