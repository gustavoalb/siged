...
def ctrl_ch_detalhado
  ...
  @relatorio.close
  FileUtils.cp(@relatorio.path,@relatorio2)
  send_file(@relatorio2,:content_type=>"application/vnd.oasis.opendocument.text",:filename=>"Controle de Carga Horária Detalhado - #{@escola.codigo}.odt")
end
